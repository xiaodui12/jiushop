...
class Create_EweiShopV2Page extends MobileLoginPage
{
    ...
    public function main()
    {
        ...
        if (!($packageid))
        {
            ...
            $default_coupon = com_run('coupon::getAvailableCoupons', 0, 0, $merch_array, $goodsdata_temp);
            ...
            $createInfo["couponid"]=empty($default_coupon[0])?0:$default_coupon[0]["id"];
    ...
    public function submit()
    {
        ...
        foreach ($goods as $g )
        {
            ...
            $merch_array[$merchid]['ggprice'] += $data['packageprice'];
