...
CREATE TABLE `ims_account_wxapp` (
  ...
  `a_uniacid` int(10) NOT NULL,
  `a_acid` int(10) NOT NULL,
...
CREATE TABLE `ims_activity_guest` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='嘉宾';
...
DROP TABLE IF EXISTS `ims_activity_signup_recording`;
CREATE TABLE `ims_activity_signup_recording` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_business` (
  ...
  `isrecommend` tinyint(2) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `ims_core_settings` VALUES ('copyright', 'a:35:{s:6:\"status\";i:0;s:4:\"demo\";s:1:\"0\";s:6:\"is_dns\";s:1:\"0\";s:8:\"is_check\";s:1:\"0\";s:10:\"verifycode\";i:0;s:6:\"reason\";s:0:\"\";s:6:\"smname\";s:0:\"\";s:8:\"sitename\";s:24:\"易福微信管理系统\";s:3:\"url\";s:20:\"http://www.efwww.com\";s:8:\"sitehost\";s:0:\"\";s:7:\"payhost\";s:0:\"\";s:8:\"statcode\";s:0:\"\";s:10:\"footerleft\";s:20:\"powered by efwww.com\";s:11:\"footerright\";s:0:\"\";s:4:\"icon\";s:0:\"\";s:3:\"ewm\";N;s:5:\"flogo\";s:0:\"\";s:14:\"background_img\";s:0:\"\";s:6:\"slides\";s:2:\"N;\";s:6:\"notice\";s:0:\"\";s:5:\"blogo\";s:0:\"\";s:8:\"baidumap\";a:2:{s:3:\"lng\";s:10:\"114.060055\";s:3:\"lat\";s:9:\"22.529554\";}s:7:\"company\";s:20:\"XX科技有限公司\";s:14:\"companyprofile\";s:0:\"\";s:7:\"address\";s:18:\"江苏省苏州市\";s:6:\"person\";s:6:\"微信\";s:5:\"phone\";s:11:\"15800008888\";s:2:\"qq\";s:7:\"XXXXXXX\";s:5:\"email\";s:0:\"\";s:8:\"keywords\";s:82:\"微信,易福,微信公众平台,公众平台二次开发,公众平台开源软件\";s:11:\"description\";s:82:\"微信,微信,微信公众平台,公众平台二次开发,公众平台开源软件\";s:12:\"showhomepage\";i:0;s:13:\"leftmenufixed\";i:0;s:13:\"mobile_status\";s:1:\"0\";s:10:\"login_type\";s:1:\"0\";}');
...
INSERT INTO `ims_core_settings` VALUES ('thirdlogin', 'a:3:{s:6:\"system\";a:3:{s:5:\"appid\";s:0:\"\";s:9:\"appsecret\";s:0:\"\";s:9:\"authstate\";s:0:\"\";}s:2:\"qq\";a:3:{s:5:\"appid\";s:0:\"\";s:9:\"appsecret\";s:0:\"\";s:9:\"authstate\";s:0:\"\";}s:6:\"wechat\";a:3:{s:5:\"appid\";s:0:\"\";s:9:\"appsecret\";s:0:\"\";s:9:\"authstate\";s:0:\"\";}}');
...
INSERT INTO `ims_modules` VALUES ('1', 'basic', 'system', '基本文字回复', '1.0', '和您进行简单对话', '一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('2', 'news', 'system', '基本混合图文回复', '1.0', '为你提供生动的图文资讯', '一问一答得简单对话, 但是回复内容包括图片文字等更生动的媒体内容. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的图文回复内容.', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('3', 'music', 'system', '基本音乐回复', '1.0', '提供语音、音乐等音频类回复', '在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('4', 'userapi', 'system', '自定义接口回复', '1.1', '更方便的第三方接口设置', '自定义接口又称第三方接口，可以让开发者更方便的接入微赞系统，高效的与微信公众平台进行对接整合。', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('5', 'recharge', 'system', '会员中心充值模块', '1.0', '提供会员充值功能', '', '易福源码网', 'http://www.efwww.com/', '0', '', '', '0', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('6', 'custom', 'system', '多客服转接', '1.0.0', '用来接入腾讯的多客服系统', '', '易福源码网', 'http://bbs.efwww.com', '0', 'a:0:{}', 'a:6:{i:0;s:5:\"image\";i:1;s:5:\"voice\";i:2;s:5:\"video\";i:3;s:8:\"location\";i:4;s:4:\"link\";i:5;s:4:\"text\";}', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('7', 'images', 'system', '基本图片回复', '1.0', '提供图片回复', '在回复规则中可选择具有图片的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝图片。', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('8', 'video', 'system', '基本视频回复', '1.0', '提供图片回复', '在回复规则中可选择具有视频的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝视频。', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('9', 'voice', 'system', '基本语音回复', '1.0', '提供语音回复', '在回复规则中可选择具有语音的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝语音。', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('10', 'chats', 'system', '发送客服消息', '1.0', '公众号可以在粉丝最后发送消息的48小时内无限制发送消息', '', '易福源码网', 'http://www.efwww.com/', '0', '', '', '0', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('11', 'wxcard', 'system', '微信卡券回复', '1.0', '微信卡券回复', '微信卡券回复', '易福源码网', 'http://www.efwww.com/', '0', '', '', '1', '1', '0', '0', '0', '', '0.00', '0', '', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('14', 'we7_coupon', 'business', '系统卡券', '4.7', '易福微信管理系统卡券', '易福微信管理系统卡券', '易福源码网', 'www.efwww.com', '1', 'a:0:{}', 'a:0:{}', '0', '0', '0', '0', '0', 'N;', '0.00', '0', 'X', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('15', 'we7_diyspecial', 'activity', '易福专题页面', '1.5', '紧跟时代步伐，拥抱HTML5，做出属于我们自己的H5营销推广页面。', '可制作两种类型的场景页：长单页场景、多页场景。一个专题页面只能制作一种类型的场景页。即一个专题页面，要么是长单页场景，要么是多页场景。', '易福源码网', 'http://www.efwww.com', '0', 'a:0:{}', 'a:1:{i:0;s:4:\"text\";}', '0', '0', '0', '0', '0', 'N;', '0.00', '0', 'Y', '1', '2', '0', '', '0', '0', '0', '0');
INSERT INTO `ims_modules` VALUES ('17', 'ewei_shopv2', 'business', '人人商城V3', '3.9.28', '人人商城V3', '人人商城V3', '易福源码网', 'http://www.efwww.com', '0', 'a:14:{i:0;s:4:\"text\";i:1;s:5:\"image\";i:2;s:5:\"voice\";i:3;s:5:\"video\";i:4;s:10:\"shortvideo\";i:5;s:8:\"location\";i:6;s:4:\"link\";i:7;s:9:\"subscribe\";i:8;s:11:\"unsubscribe\";i:9;s:2:\"qr\";i:10;s:5:\"trace\";i:11;s:5:\"click\";i:12;s:4:\"view\";i:13;s:14:\"merchant_order\";}', 'a:12:{i:0;s:4:\"text\";i:1;s:5:\"image\";i:2;s:5:\"voice\";i:3;s:5:\"video\";i:4;s:10:\"shortvideo\";i:5;s:8:\"location\";i:6;s:4:\"link\";i:7;s:9:\"subscribe\";i:8;s:2:\"qr\";i:9;s:5:\"trace\";i:10;s:5:\"click\";i:11;s:14:\"merchant_order\";}', '0', '0', '0', '0', '0', 'a:0:{}', '0.00', '0', 'R', '1', '2', '0', '', '0', '1', '0', '0');
...
INSERT INTO `ims_modules_bindings` VALUES ('41', 'ewei_shopv2', 'cover', '', '商城入口', 'mobile', '', '0', '', '', '0');
INSERT INTO `ims_modules_bindings` VALUES ('42', 'ewei_shopv2', 'menu', 'getMenus', '', '', '', '0', '', '', '0');
...
DROP TABLE IF EXISTS `ims_modules_reply`;
CREATE TABLE `ims_modules_reply` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
...
INSERT INTO `ims_uni_account_modules` VALUES ('7', '1', 'we7_coupon', '1', '', '0', '0');
INSERT INTO `ims_uni_account_modules` VALUES ('9', '1', 'ewei_shopv2', '1', '', '0', '0');
...
INSERT INTO `ims_users_group` VALUES ('1', '体验用户组', 'a:1:{i:0;i:1;}', '1', '1', '0.00', '0', null, '0.00', '0', '0', '0', '0', '0');
INSERT INTO `ims_users_group` VALUES ('2', '白金用户组', 'a:1:{i:0;i:1;}', '2', '2', '0.00', '0', null, '0.00', '0', '0', '0', '0', '0');
INSERT INTO `ims_users_group` VALUES ('3', '黄金用户组', 'a:1:{i:0;i:1;}', '3', '3', '0.00', '0', null, '0.00', '0', '0', '0', '0', '0');
...
DROP TABLE IF EXISTS `ims_wechat_agency`;
CREATE TABLE `ims_wechat_agency` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) NOT NULL,
  `code` varchar(20) NOT NULL,
  `title` varchar(50) NOT NULL,
  `img` varchar(255) NOT NULL,
  `aliyun` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS `ims_wechat_daili`;
CREATE TABLE `ims_wechat_daili` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `ims_wechat_dailicoop`;
CREATE TABLE `ims_wechat_dailicoop` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `weid` int(10) DEFAULT NULL,
  `title` varchar(30) DEFAULT NULL,
  `money` varchar(30) DEFAULT NULL,
...
DROP TABLE IF EXISTS `ims_wechat_dailitop`;
CREATE TABLE `ims_wechat_dailitop` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `weid` int(10) DEFAULT NULL,
  `title` varchar(30) DEFAULT NULL,
  `money` varchar(30) DEFAULT NULL,
