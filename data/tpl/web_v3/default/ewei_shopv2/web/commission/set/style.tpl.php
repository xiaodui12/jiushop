...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
	<div class="input-group">
	    <div class="input-group-addon">我的粉丝</div>
	    <?php if(cv('commission.set.edit')) { ?>
	    	<input type="text" name="texts[mydown]" class="form-control" value="<?php echo empty($data['texts']['mydown'])?'我的粉丝':$data['texts']['mydown']?>"  />
	    <?php  } else { ?>
	    	<div class="form-control valid"><?php echo empty($data['texts']['mydown'])?'我的粉丝':$data['texts']['mydown']?></div>
	    <?php  } ?>
	</div>
    </div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9 col-xs-12">
		<div class="input-group">
			...
			<?php  } else { ?>
			<div class="form-control valid"><?php echo empty($data['texts']['yuan'])?'我的粉丝':$data['texts']['yuan']?></div>
			<?php  } ?>
		</div>
	</div>
</div>
