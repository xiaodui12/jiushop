...
<div  id="rebate_rate" >
<div class="form-group" >
	<label class="col-lg control-label">返现比例</label>
	<div class="col-sm-9 col-xs-12">
		<div class="input-group fixmore-input-group">

			<input type="text" name="data[rebate_rate]" class="form-control valid" value="<?php  echo $data['rebate_rate'];?>" aria-invalid="false">
