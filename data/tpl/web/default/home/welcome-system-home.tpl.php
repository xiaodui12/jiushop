				...
				<div class="content">
					...
					<div class="app-item-footer">
						...
						<div class="info">
							...
							<div class="version text-over" ng-if="list.account.level == 1">类型：普通订阅号</div>
							<div class="version text-over" ng-if="list.account.level == 2">类型：普通服务号</div>
							<div class="version text-over" ng-if="list.account.level == 3">类型：认证订阅号</div>
							<div class="version text-over" ng-if="list.account.level == 4">类型：认证服务号</div>
